Attribute VB_Name = "CollectionHelper"
Option Explicit
...
Public Function Contains(ByRef Item As Variant, ByRef Items As Collection, ByRef Comparer As IVBAEqualityComparer) As Boolean
...
Public Function IndexOf(ByRef Item As Variant, ByRef Items As Collection, ByRef Comparer As IVBAEqualityComparer) As Long
